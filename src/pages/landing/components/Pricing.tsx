      ...
      <div className="mx-auto max-w-7xl px-5 lg:px-8">
        <Reveal>
          <div className="text-center max-w-2xl mx-auto">
            <span className="text-sm font-medium text-primary uppercase tracking-wider">{t.pricing.label}</span>
            <h2 className="mt-3 text-3xl sm:text-4xl lg:text-5xl font-bold tracking-tight">
              {t.pricing.h2}
            </h2>
            <p className="mt-4 text-muted-foreground">{t.pricing.p}</p>
          </div>
        </Reveal>
          ...
          <div className="mt-14 max-w-md mx-auto">
            <div className="relative rounded-3xl border border-border bg-card p-8 shadow-card">
              ...
              <div className="text-center pt-3">
                ...
                <p className="mt-2 text-sm text-muted-foreground">{t.pricing.period}</p>
              </div>
              ...
              <Button className="w-full mt-8 rounded-full h-12 text-base shadow-glow" asChild>
                <a href={`${APP_URL}/login`}>{t.pricing.btn}</a>
              </Button>
              <p className="mt-3 text-xs text-center text-muted-foreground">{t.pricing.noCard}</p>
            </div>
          </div>
        </Reveal>
      </div>
